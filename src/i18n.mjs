export const T = {
  fr: {
    ...
    specNote: 'Les dimensions exactes, le raccordement, la capacité et les autres données techniques ne sont publiés qu’après validation de la fiche fabricant.',
  ...
  en: {
    ...
    specNote: 'Exact dimensions, connection requirements, capacity and other technical data are published only after validation against the manufacturer technical sheet.',
  ...
  ar: {
    ...
    specNote: 'الأبعاد الدقيقة ومتطلبات التوصيل والسعة وباقي البيانات التقنية لا تنشر إلا بعد مطابقتها مع ورقة المصنع.',
